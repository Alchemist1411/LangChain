...
7. Get transaction details with getTransactionHash
8. Check contract status with checkContractStatus
9. Get the total number of transactions for a specified wallet address with getTotalTransactions
